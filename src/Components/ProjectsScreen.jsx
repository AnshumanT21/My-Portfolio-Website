...
const ProjectsScreen = () => {
  ...
  const projects = [
    {
  title: 'ClaimIQ',
  subtitle: 'An AI-powered document intelligence platform that automates insurance claim processing end-to-end.',
  handle: 'FastAPI • React/Vite • Supabase • GPT-4o',
  image: 'https://res.cloudinary.com/dwrts9bjq/image/upload/v1786565570/0fe5cc2d-4f3b-47bb-bb64-150051468a8c.png',
  url: 'https://claimiq.in/',
  borderColor: '#0EA5E9',
  gradient: 'linear-gradient(165deg, rgba(14, 165, 233, 0.3), rgba(0,0,0,0.8))',
  shape: 'icosahedron',

  category: 'AI SaaS Platform',
  description: "ClaimIQ is a full-stack document intelligence platform built for insurance claim processing, designed to replace slow, manual claim review with an automated, auditable pipeline. It ingests raw claim documents, extracts structured data, and generates client-ready reports without a human ever touching a spreadsheet.",
  challenge: "Insurance claim adjusters spend the majority of their time manually reading, classifying, and cross-referencing dense paperwork — intimation letters, discharge vouchers, post-mortem reports, certificates — often in mixed Hindi/English formats and inconsistent layouts. The bottleneck isn't judgment, it's data entry. The challenge was building a system accurate enough to remove that bottleneck without sacrificing the traceability adjusters rely on.",
  approach: "The pipeline combines Google Document AI for OCR with GPT-4o for classification and structured field extraction, backed by a Supabase data layer and Cloudflare R2 for document storage. A multi-client report template registry decouples extraction logic from report generation, so new insurance lines and new clients can be onboarded without touching the core pipeline. Confidence scoring and an editable checklist UI keep a human in the loop for final review.",
  results: "The platform is live in production, with a fully working marine insurance line (ILA and FSR report generation) already deployed for a real client. A cattle insurance line is currently in development, built on 10 real claim cases and extending the same architecture to a new document schema and single-report workflow — demonstrating the system's ability to scale across insurance verticals.",
  technologies: ['FastAPI', 'React/Vite', 'Supabase', 'Cloudflare R2', 'OpenAI GPT-4o', 'Google Document AI'],
  year: '2026',
},
{
  title: 'Concierge AI',
  ...
  description: "Concierge AI is a multi-tenant chatbot platform purpose-built for the travel and hospitality industry, developed during my internship at Aionos. Companies upload their own SOPs, FAQs, and policy documents to build a dedicated knowledge base, then deploy a fully branded AI concierge to their website via a lightweight embed — no engineering effort required on their end.",
  challenge: "Hospitality businesses field the same repetitive guest questions — check-in policies, amenities, local recommendations — but generic chatbots hallucinate answers or can't be trusted with brand voice. The challenge was building a platform flexible enough to support many independent clients and knowledge bases, while keeping answers grounded strictly in each company's own documentation.",
  approach: "Each client gets isolated Collections and Knowledge Bases, with documents processed and embedded for retrieval-augmented responses. The public-facing widget supports anonymous chat, proactive starter questions, follow-up suggestions, and inline source citations so users can verify where an answer came from. A voice mode was layered on top using OpenAI's Realtime API, giving guests a natural, low-latency voice interface alongside text.",
  results: "The platform supports multi-bot document management, a full analytics-ready architecture, and a production voice bot system spanning bot management, embeddable widgets, and real-time audio streaming. The result is a white-label, embeddable AI concierge that any hospitality brand can deploy without writing a line of code.",
  technologies: ['FastAPI', 'Supabase', 'OpenAI API', 'Cloudflare R2', 'React/Vite', 'Tailwind CSS'],
  year: '2026',
},
{
  title: 'Signal Desk',
  ...
  description: "Signal Desk is a social listening platform that tracks brand and topic mentions across multiple online sources in real time, built during my internship at Aionos. It consolidates scattered, unstructured chatter into a single dashboard with sentiment scoring and platform-level breakdowns, giving teams a live pulse on how they're being talked about online.",
  challenge: "Brand mentions live across dozens of disconnected platforms, each with different APIs, rate limits, and access restrictions. The challenge was building a reliable data-collection layer that could pull from multiple sources consistently, normalize the results, and surface meaningful sentiment trends without manual monitoring.",
  approach: "A three-tier architecture separates concerns cleanly: a forked, extended data-collection engine handles multi-source search and retrieval, a FastAPI backend processes and structures the incoming data, and a React/Vite dashboard visualizes it. The dashboard is organized into Overview, Mentions, and Platforms views, each surfacing a different cut of the sentiment and volume data collected.",
  results: "The end-to-end system was validated with real test data across all three dashboard views, confirming reliable data flow from collection through to visualization. The architecture is built to extend to additional data sources and platforms as the tool matures beyond its current phase.",
  technologies: ['Python', 'FastAPI', 'React/Vite', 'YouTube Data API', 'Serper.dev'],
  year: '2026',
},
    {
      title: 'Dev Vault',
